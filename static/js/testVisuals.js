function tests(dataArray, bufferLength) {
        ...
        function addWord() {
            ...
            for (var i = 0; i < textSample.length; i++) {
                ...
                canvasCtx.strokeText(
                    textSample[i],
                    xPos + Math.random() * (fontSize * 2),
                    yPos + Math.random() * (fontSize * 2)
                );
		...
		*/
        ...
        for (var i = 0; i < graphSubD; i++) {
            for (var j = 0; j < graphSubD; j++) {
                ...
                n = PerlinNoise.noise(size * normX, size * normY, 0.8);
    ...
    function noiseAgent() {
        ...
        var Agent = new (function () {
            ...
            this.update1 = function () {
                ...
                var n = PerlinNoise.noise(size * normX, size * normY, 0.8); //not sure how to apply noise scale here
            ...
            this.update2 = function () {
                ...
                this.angle =
                    (this.angle - Math.round(this.angle)) * noiseStrength;
    ...
    function dumbAgents(dataArray, bufferLength) {
        ...
        function draw() {
            canvasCtx.fillStyle =
                'rgba(237, 230, 224, ' + visGuiSettings.alpha + ')';
            canvasCtx.fillRect(0, 0, canvWidth, canvHeight);
